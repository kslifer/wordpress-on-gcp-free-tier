...
FROM wordpress:6.8.0-php8.4-apache
...
ENV WORDPRESS_CONFIG_EXTRA=define(\'WP_STATELESS_MEDIA_CACHE_BUSTING\',true);define(\'JETPACK_SIGNATURE__HTTPS_PORT\',8080);define(\'WP_MEMORY_LIMIT\',\'512M\');define(\'AUTOMATIC_UPDATER_DISABLED\',true);define(\'WP_POST_REVISIONS\',3);define(\'AUTOSAVE_INTERVAL\',86400);
