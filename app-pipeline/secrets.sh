...
echo $(cat ./run/secrets/WORDPRESS_TABLE_PREFIX)
echo $(cat ./run/secrets/WORDPRESS_DB_NAME)
echo $(cat ./run/secrets/WORDPRESS_DB_USER)
echo $(cat ./run/secrets/WORDPRESS_DB_PASSWORD)
echo $(cat ./run/secrets/WORDPRESS_DB_HOST)